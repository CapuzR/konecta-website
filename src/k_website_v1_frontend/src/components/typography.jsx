  ...
  return (
    <p
        style={{
            ...
            fontSize: size === "tiny" ? "clamp(0.2rem, 0.5vw, 1.5rem)" : size === "small" ? "clamp(0.4rem, 0.8vw, 2rem)" : size === "medium" ? "clamp(0.4rem, 1.2vw, 4rem)" : size === "big" ? "clamp(0.75rem, 2vw, 6rem)" : size === "XL" ? "clamp(1.5rem, 3vw, 12rem)"  : "clamp(1.5rem, 4vw, 12rem)",
            fontStyle: "normal",
            fontWeight: "500px",
            lineHeight: "35px",
